...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def __init__(
        ...
        self._supports_prefetch = True   #getattr(dataset, "supports_prefetch", False)
    ...
    def first_batch(self):
        ...
        if getattr(self.dataset, "supports_fetch_outside_dataloader", True):
            self.dataset.prefetch([i for i in self.frozen_batches[0]])
    ...
    def _get_iterator_for_epoch(
        ...
        # itr =  BackgroundGenerator(itr, max_prefetch = 10)
