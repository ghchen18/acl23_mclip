...
class TranslationMultiSimpleEpochTask(LegacyFairseqTask):
    ...
    def __init__(self, args, langs, dicts, training, cfg = None):
        super().__init__(args)
        self.langs = langs
        self.dicts = dicts
        self.cfg = cfg 
        ...
        self.data_manager = MultilingualDatasetManager.setup_data_manager(
            args, self.lang_pairs, langs, dicts, self.sampling_method, cfg = cfg,
        )
    ...
    def setup_task(cls, args, **kwargs):
        ...
        cfg = kwargs['cfg_all'] if 'cfg_all' in kwargs else args 
        return cls(args, langs, dicts, training, cfg = cfg)
